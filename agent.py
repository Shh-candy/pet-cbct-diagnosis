...
class PetCBCTDiagnosisAgent:
    def __init__(self):
        # 初始化LLM（支持多模态）
       # DEEPSEEK_API_KEY="sk-270fcc66191d4e3faaac3ec88df5031d"
       ...
       DOUBAO_API_KEY="b53bbe87-8230-4bb7-b2d7-2c5e772c591e"
       DOUBAO_BASE_URL = "https://ark.cn-beijing.volces.com/api/v3"  # DeepSeek API 地址
       MODEL_NAME = "doubao-seed-2-0-pro-260215"  # DeepSeek通用对话模型（如需多模态用deepseek-multi-modal）
       temperature=0.7
       timeout=60
